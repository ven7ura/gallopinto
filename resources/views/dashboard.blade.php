    ...
    <div class="bg-white dark:bg-slate-800">
        <div class="flex flex-col md:flex-row max-w-screen-lg mx-auto dark:bg-slate-800" x-data="{ 
            ...
            <div class="sm:m-6 lg:m-8 basis-1/2 px-2 sm:px-0">
                ...
                <div>
                    <div x-show="newsTab == '#hot-news'" x-cloak>
                        <x-dashboard.reddit.hot-news />
                    </div>
                    <div x-show="newsTab == '#trending-news'" x-cloak>
                        <x-dashboard.reddit.trending-news />
                    </div>
                    <div x-show="newsTab == '#world-news'" x-cloak>
                        <x-dashboard.reddit.world-news />
                    </div>
                    <div x-show="newsTab == '#google-news'" x-cloak>
                        <x-dashboard.google.global-news />
                    </div>
                </div>
            </div>
            <div class="sm:m-6 lg:m-8 basis-1/2 px-2 sm:px-0">
                ...
                <div>
                    <div x-show="devTab == '#laravel'" x-cloak>
                        <x-dashboard.reddit.laravel />
                    </div>
                    <div x-show="devTab == '#vue'" x-cloak>
                        <x-dashboard.reddit.vue />
                    </div>
                    <div x-show="devTab == '#css'" x-cloak>
                        <x-dashboard.reddit.css />
                    </div>
                    <div x-show="devTab == '#programming'" x-cloak>
