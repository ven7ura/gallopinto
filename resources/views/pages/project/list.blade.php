<x-guest-layout title="Lista de proyectos">
    @seo(['description' => 'Lista de proyectos'])
    ...
    <div
        class="prose dark:prose-invert prose-h1:tracking-tighter max-w-screen-lg mx-auto px-2 sm:px-6 lg:px-8 my-4 sm:my-12 lg:my-16">
            ...
            <article class="relative flex flex-col max-w-3xl lg:ml-auto lg:max-w-none lg:w-[50rem]">
                <h3 class="text-xl tracking-tight font-bold dark:text-white dark:hover:text-orange-300">
                    <a class="underline dark:text-white dark:hover:text-orange-300"
                        href="{{ route('page.project.detail', ['codename' => $series->codename]) }}">{{ $series->project
                        }}</a>
                </h3>
