<x-guest-layout title="{{ $post->title }}">
    ...
    <div class="flex flex-col-reverse md:flex-row max-w-screen-lg mx-auto px-2 sm:px-6 lg:px-8">
        <article class="prose dark:prose-invert dark:prose-p:text-gray-400 prose-pre:bg-zinc-900 prose-h1:tracking-tighter prose-h2:font-extrabold prose-h2:tracking-tighter prose-h3:font-extrabold prose-h3:tracking-tighter prose-h4:tracking-tighter pt-4 md:prose-lg lg:prose-xl sm:flex-col-reverse line-numbers">
            <div>
                {{ $post->contents }}
            </div>
        </article>
