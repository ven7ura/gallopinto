...
`searchTerm` se encargara de tener sincronizado los valores de nuestro campo de texto que tendremos en el componente el la parte HTML con la de la clase `PostList`.
